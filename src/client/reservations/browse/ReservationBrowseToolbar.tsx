...
export function ReservationBrowseToolbar(props: ReservationBrowseToolbarProps) {
  ...
  return (
    <>
      <header className="mb-3 flex flex-wrap items-center gap-4 rounded-[18px] bg-surface-muted py-3.5 pr-4 pl-[22px] max-[720px]:hidden">
        ...
        <div className="ml-auto inline-flex shrink-0 items-center gap-2">
          <div
            className="reservation-view-mode inline-flex min-h-[34px] items-center gap-[3px] rounded-[11px] bg-surface p-[3px] shadow-xs [&_.trek-btn]:min-h-7 [&_.trek-btn]:rounded-lg [&_.trek-btn]:px-[9px] [&_.trek-btn]:py-[5px] [&_.trek-btn]:text-xs"
          ...
          <button
            type="button"
            className="trek-btn trek-btn--primary min-h-[38px] rounded-[10px] px-3.5 py-2 text-[13px] font-semibold"
      ...
      <header className="mb-3 rounded-[18px] bg-surface-muted p-4 min-[721px]:hidden">
        <div className="flex items-center justify-between gap-3">
          <h1 className="m-0 text-lg font-semibold leading-tight">Reservations</h1>
          <button
            type="button"
            className="trek-btn trek-btn--primary min-h-[38px] shrink-0 rounded-[10px] px-3 py-2 text-[13px] font-semibold"
            onClick={props.onAddReservation}
          >
            <Plus size={14} />
            <span>Reservation</span>
        ...
        {props.reservationCount > 0 ? (
          <div className="-mx-1 mt-3 overflow-x-auto px-1 pb-2" aria-label="Reservation categories">
      ...
      <div ref={menuAreaRef} className="mb-[22px] flex flex-wrap items-center gap-2.5 px-0.5">
        ...
        <div className="relative max-[720px]:hidden">
          <button
            type="button"
        ...
        <div className="flex w-full flex-col gap-2.5 min-[721px]:hidden">
          ...
          {filterOpen ? (
            <div
              className="rounded-xl border border-edge bg-surface p-2 shadow-lg"
              role="region"
        ...
        <span className="ml-auto hidden whitespace-nowrap text-xs font-semibold text-content-faint min-[721px]:block">
